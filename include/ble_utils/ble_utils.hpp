...
namespace ble_utils::gatt
{
    ...
    public:
         ...
         */
        Characteristic(const bt_uuid *uuid, uint8_t props, uint8_t perm) : Characteristic(uuid, props, perm, false) {}
    ...
    public:
         ...
         *
         * @return bt_uuid_128* pointer to the 128 bit uuid.
         */
        bt_uuid_128 *get_uuid();
